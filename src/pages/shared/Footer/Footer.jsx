                      ...
                      <div className="">
                          ...
                          <p className="mt-4 text-sm md:text-left text-center text-[gray]">
                            ...
                            totam rem aperiam.
                             ...
                             <div class="goodfirm-widget" data-widget-type="goodfirms-widget-t8" data-widget-pattern="poweredby-star" data-height="60" data-company-id="134938"></div>
                      </div>
                                    ...
                                    <h2 className="text-white font-semibold md:text-left text-center md:mt-0 mt-4">Our Services</h2>
                                     <ul className="">
                                         <li className='mt-3 md:text-left text-center'>
                                              <Link to='' className="text-[#00bfff]  hover:border-b-2 hover:border-blue-500 ">Web Apps</Link> 
                                         </li>
                                         <li className='mt-3 md:text-left text-center'>
                                              <Link to='' className="text-[#00bfff]  hover:border-b-2 hover:border-blue-500">ECommerce</Link> 
                                         </li>
                                         <li className='mt-3 md:text-left text-center'>
                                              <Link to='' className="text-[#00bfff]  hover:border-b-2 hover:border-blue-500">Mobile Apps</Link> 
                                         </li>
                                         <li className='mt-3 md:text-left text-center'>
