            ...
            <div className="relative px-4  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 flex items-center justify-between">
                    <form onSubmit={handleSignUp} className='md:h-[400px]' >
                        ...
                        <div className="md:flex gap-3 mt-8">
                             <input require className="bg-[#22243eb6] border-0 rounded-xl py-3" type="text" name="fName" placeholder='enter your first name' />
                             
                              <input required className="bg-[#22243eb6] border-0 rounded-xl py-3" type="text" name="lName" placeholder='enter your last name' />
                        </div>
