...
const OurMission = () => {
    const [des,setDes] = useState('  Driving Innovation, Delivering Exceptional Experiences: Bright Future empowers businesses with cutting-edge software solutions, fostering collaboration and making a positive impact on society.')
    const missionData=[
        {
            id : 0,
            img : power,
