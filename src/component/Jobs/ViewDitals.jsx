            ...
            <section className="py-12 bg-white sm:py-16 lg:py-20">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto xl:max-w-4xl mt-4">
                        ...
                        <p className=" font-semibold text-gray-800 mt-7 text-xl font-pj">
                        ...
                        <p className="text-xl font-bold text-gray-900 mt-7 sm:text-xl xl:text-xl font-pj">
                                ...
                                <div className={`fixed  z-50 top-0 left-0 flex h-full min-h-screen w-full items-center justify-center bg-black bg-opacity-90 px-4 py-5  ${apply ? "block" : "hidden"
                                    ...
                                    <form onSubmit={apply_job_post} class="">
                                        <div class="max-h-screen my-10">
                                            ...
                                            <div class="mt-6  overflow-hidden bg-white max-w-4xl mx-auto  rounded-lg shadow md:mt-10">
                                                <div class="w-full max-w-[800px] max-h-[90%]  overflow-y-scroll rounded-[20px] mt-4 text-start bg-white relative pb-10 px-8  md:px-[30px] ">
                                                        ...
                                                        <div class="p-4">
                                                            <div class="sm:flex sm:items-center sm:justify-between">
                                                                <div class="flex items-center flex-1">
                                                                    ...
                                                                    <p class="ml-3 text-base font-normal text-gray-900">{name ? name : 'Upload Your Resume '} </p>
                                                                </div>
                                                                ...
                                                                <button type='button' onClick={() => { setApply(false), setName(false), setResume(false) }} className='hover:bg-red-500 border text-black cursor-pointer ml-3 bg-red-100 rounded-full w-8 h-8 flex justify-center items-center'>
                                                    ...
                                                    <p class="mt-6 text-base font-bold text-gray-900">Personal Information</p>
                                                    <div class="grid grid-cols-1 mt-6 sm:grid-cols-2 gap-x-6 gap-y-5 ">
                                                        ...
                                                        {/* <div>
                                                            ...
                                                            <label for=""> Phone Number with Country Code </label>
                                                            <div class="block mt-2 w-full p-0.5  text-sm font-normal text-gray-900 placeholder-gray-500 bg-white border  rounded-md caret-gray-900 focus:ring-gray-900 border-gray-500 ">
                                                                <Select options={country_code}></Select> <input type="text" name="phone_number" id="" placeholder="" class="w-full px-4 py-2 border-none" />
                                                            </div>
                                                        </div> */}
                                                        <div>
