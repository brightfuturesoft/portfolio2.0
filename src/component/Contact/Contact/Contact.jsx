...
const Contact = () => {
    ...
    return (
        <div className="contact-bg">
            ...
            {/* <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 contact-box ">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl ">
                    ...
                    <div className="max-w-5xl mx-auto mt-12 sm:mt-16 ">
                        <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                            <div className="overflow-hidden text-gray-400 form-bg rounded-xl">
                                <div className="p-6">
                                    ...
                                    <a href="tel:+880 1792-205520" className="mt-6 text-lg font-medium ">+880 1792-205520</a>
                                    <p className="mt-1 text-lg font-medium ">+88</p>
                                </div>
                            </div>

                            <div className="overflow-hidden form-bg rounded-xl text-gray-400">
                                <div className="p-6">
                                    <svg className="flex-shrink-0 w-10 h-10 mx-auto text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <p className="mt-6 text-lg font-medium ">contact@brightfuturesoft.com</p>
                                    <p className="mt-1 text-lg font-medium ">hr@brightfuturesoft.com</p>
                                </div>
                            </div>
                            ...
                            <div className="overflow-hidden bg-white rounded-xl">
                                <div className="p-6">
                                    ...
                                    <p className="mt-6 text-lg font-medium leading-relaxed text-gray-900">Fully Remote, </p>
                                </div>
                            </div>
                        </div>
