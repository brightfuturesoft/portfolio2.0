...
const OurVission = () => {
    const [descridtion, setDescribtion] = useState(' Our vision is to be a leading force in the software industry, driving digital transformation, and empowering businesses and individuals with innovative solutions that shape a brighter future.')
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 mt-16">
                            ...
                            <div className="md:block hidden">
                                ...
                                <ul className="grid md:grid-cols-2 grid-cols-1 mt-5 gap-3 ">
                                        {
                                            missionData.map(mData => <li onClick={()=>setDescribtion(mData.des)} className="flex items-center  gap-2 duration-200 cursor-pointer hover:bg-[#22283db1] p-2 rounded" key={mData.id}>
                                                <span className="border border-blue-600 rounded-md">
                                                    <img  loading="lazy"src={mData.img} alt="" className="w-[50px]" />
                                                </span>
